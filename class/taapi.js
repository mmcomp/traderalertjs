...
class TaapiReaderClass {
    ...
    async getIndicator(indicator, source, symbol, interval, params, backtrack) {
        ...
        return new Promise(async function(resolve, reject){
            try{
                let result = await client.getIndicator("bbands2", "binance", "BTC/USDT", interval)//client.getIndicator("bbands2", "binance", "BTC/USDT", "4h")//client.getIndicator(indicator, source, symbol, interval, params, backtrack)
                resolve(result)
            }catch(e){
                reject(e)
            }
